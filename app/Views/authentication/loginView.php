                ...
                <div class="row g-0 h-100">
                  <div class="col-md-5 text-center bg-card-gradient">
                    <div class="position-relative p-4 pt-md-5 pb-md-7 light">
                      ...
                      <div class="z-index-1 position-relative"><a class="link-light mb-4 font-sans-serif fs-4 d-inline-block fw-bolder" href="index.html">Sphera</a>
                        <p class="opacity-75 text-white">Con Sphera Dashboard tendra acceso a información de registro y datos estadisticos al dia de sus clientes!</p>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-7 d-flex flex-center">
                    <div class="p-4 p-md-5 flex-grow-1">
                      <div class="row flex-between-center">
                        <div class="col-auto">
                          <h3>Ingreso a la cuenta</h3>
                        </div>
                      </div>
                      <!-- Login Form -->
                      <?php 
                          echo form_open('loginController/checklogin', 'class="form-signin"');
                      ?>
